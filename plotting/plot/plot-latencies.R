...
ylimglobalnoop <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Global\nQ" & data$benchmark_name == 'NoOp'] / 10**3), ylim_expansion)
ylimglobalycsb <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Global\nQ" & data$benchmark_name == 'YCSB']/ 10**3), ylim_expansion)
ylimglobaltpcc <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Global\nQ" & data$benchmark_name == 'TPC-C']/ 10**3), ylim_expansion)
ylimlocalnoop <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Local\nQ" & data$benchmark_name == 'NoOp']/ 10**3), ylim_expansion)
ylimlocalycsb <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Local\nQ" & data$benchmark_name == 'YCSB']/ 10**3), ylim_expansion)
ylimlocaltpcc <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Local\nQ" & data$benchmark_name == 'TPC-C']/ 10**3), ylim_expansion)
ylimbasenoop <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Base-\nline" & data$benchmark_name == 'NoOp']/ 10**3), ylim_expansion)
ylimbaseycsb <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Base-\nline" & data$benchmark_name == 'YCSB']/ 10**3), ylim_expansion)
ylimbasetpcc <- mapply("-", range(data$latency_us[data$patch_global_quiescence == "Base-\nline" & data$benchmark_name == 'TPC-C']/ 10**3), ylim_expansion)
...
plot <- ggplot() +
  ...
  facetted_pos_scales(
    y = list(
      patch_global_quiescence == "Base-\nline" & benchmark_name == "NoOp" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimbasenoop),
      patch_global_quiescence == "Base-\nline" & benchmark_name == "NoOp" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimbasenoop, guide = "none"),
      
      patch_global_quiescence == "Base-\nline" & benchmark_name == "YCSB" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimbaseycsb),
      patch_global_quiescence == "Base-\nline" & benchmark_name == "YCSB" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimbaseycsb, guide = "none"),
      
      patch_global_quiescence == "Base-\nline" & benchmark_name == "TPC-C" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimbasetpcc),
      patch_global_quiescence == "Base-\nline" & benchmark_name == "TPC-C" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimbasetpcc, guide = "none"),    
      
      patch_global_quiescence == "Global\nQ" & benchmark_name == "NoOp" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimglobalnoop),
      patch_global_quiescence == "Global\nQ" & benchmark_name == "NoOp" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimglobalnoop, guide = "none"),
      
      patch_global_quiescence == "Global\nQ" & benchmark_name == "YCSB" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimglobalycsb),
      patch_global_quiescence == "Global\nQ" & benchmark_name == "YCSB" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimglobalycsb, guide = "none"),
      
      patch_global_quiescence == "Global\nQ" & benchmark_name == "TPC-C" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimglobaltpcc),
      patch_global_quiescence == "Global\nQ" & benchmark_name == "TPC-C" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimglobaltpcc, guide = "none"),
      
      patch_global_quiescence == "Local\nQ" & benchmark_name == "NoOp" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimlocalnoop),
      patch_global_quiescence == "Local\nQ" & benchmark_name == "NoOp" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimlocalnoop, guide = "none"),
      
      patch_global_quiescence == "Local\nQ" & benchmark_name == "YCSB" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimlocalycsb),
      patch_global_quiescence == "Local\nQ" & benchmark_name == "YCSB" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimlocalycsb, guide = "none"),
      
      patch_global_quiescence == "Local\nQ" & benchmark_name == "TPC-C" & experiment_commit == "ID: 1" ~ scale_y_log10(limits = ylimlocaltpcc),
      patch_global_quiescence == "Local\nQ" & benchmark_name == "TPC-C" & experiment_commit != "ID: 1" ~ scale_y_log10(limits = ylimlocaltpcc, guide = "none")
    )
  )
...
ggplot.save(plot +
            ...
            , "Latencies-Cutout", width=16, height=9, use.grid=FALSE)
